...
const folders = [
  {
    ...
    icon: '🗄️',
    color: '#00a6e2',
    desc: '22 workbooks — Liverpool, E1, Grays, matched, 42-candidate shortlist',
    items: ['01–07 core workbooks', '20_Liverpool_10_Mile_Matched_Properties.xlsx', '21_BRRR_BMV_42_Candidates_Positive_Lead.xlsx', '22_Liverpool_Wirral_Deep_Analysis_Final.xlsx'],
  },
  {
    name: 'case_studies/',
    icon: '🏠',
    color: '#9b0984',
    desc: '19 files — 8 properties: checklist + max offer + legal review',
    items: ['08–11 core deep-dives', '12_Sulby_Avenue', '13_Greenwood_House', '14_Rufford_Road', '15_Exeter_Road', '16_Sandy_Grove', '17_Marlborough', '18_Solicitor_Review_Argent', '19_Parsonage_Deep_Drive'],
  },
  {
    name: 'prompt_library/',
    icon: '🤖',
    color: '#13ce66',
    desc: 'Reusable prompts & agent workflows + master prompts',
    items: ['property_research/', 'content_production/', 'agent_operations/', 'admin_workflow/', 'Elite_Acquisition_Master_Prompt.md'],
  },
  {
    name: 'ai/',
    icon: '⚙️',
    color: '#4d65ff',
    desc: 'Agent stack + real automation scripts (Chrome CDP scraper, pipeline, rank, audit)',
    items: ['agent_stack_workflows.md', 'scripts/rightmove_scraper.py', 'scripts/property_pipeline.py', 'scripts/audit_engine.py', 'scripts/OPERATING_MANUAL.md'],
  },
  {
    name: 'client_work/',
    icon: '🤝',
    color: '#ff659d',
    desc: 'B2B LinkedIn content delivered for client (Ruhrose)',
    items: ['ruhrose_linkedin/ — briefing, content plan, 5 post series'],
  },
  {
    name: 'daily_reports/',
    icon: '📆',
    color: '#ff8c42',
    desc: 'Daily research workflow outputs',
    items: ['Active_Property_Screening_15062026.xlsx', 'BRRR_Analysis_Max_Offer_21072026.xlsx', 'Cross_Checked_Costs_Verified.xlsx'],
  },
  {
